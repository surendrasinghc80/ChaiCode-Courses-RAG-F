...
export async function createCourse(courseData) {
  try {
    const response = await apiClient.post(CourseApi.CreateCourse, courseData);
    return response.data;
  } catch (error) {
...
export async function getCourses(options = {}) {
  const { page = 1, limit = 10, topic, difficulty, isActive } = options;
  ...
  try {
    ...
    const response = await apiClient.get(
      `${CourseApi.GetCourses}?${params.toString()}`
    );
    return response.data;
  } catch (error) {
    throw new Error(`Get courses failed: ${error.message}`);
  }
}
...
export async function updateCourse(courseId, updateData) {
  try {
    const response = await apiClient.put(
      CourseApi.UpdateCourse.replace(":courseId", courseId),
      updateData
    );
    return response.data;
  } catch (error) {
    throw new Error(`Update course failed: ${error.message}`);
  }
}
...
export async function deleteCourse(courseId) {
  try {
    const response = await apiClient.delete(
      CourseApi.DeleteCourse.replace(":courseId", courseId)
    );
    return response.data;
  } catch (error) {
...
export async function grantCourseAccess(accessData) {
  try {
    const response = await apiClient.post(CourseApi.GrantCourseAccess, accessData);
    return response.data;
  } catch (error) {
    throw new Error(`Grant course access failed: ${error.message}`);
  }
}

export async function revokeCourseAccess(accessData) {
  try {
    const response = await apiClient.post(CourseApi.RevokeCourseAccess, accessData);
    return response.data;
  } catch (error) {
    throw new Error(`Revoke course access failed: ${error.message}`);
  }
}

export async function getUserCourses(userId = null) {
  try {
    const endpoint = userId 
      ? CourseApi.GetUserCoursesById.replace(":userId", userId)
      : CourseApi.GetUserCourses;
    
    const response = await apiClient.get(endpoint);
    return response.data;
  } catch (error) {
    throw new Error(`Get user courses failed: ${error.message}`);
  }
}

export async function getRagStats(userId = null) {
  try {
    const endpoint = userId 
      ? CourseApi.GetRagStatsById.replace(":userId", userId)
      : CourseApi.GetRagStats;
    
    const response = await apiClient.get(endpoint);
    return response.data;
  } catch (error) {
    throw new Error(`Get RAG stats failed: ${error.message}`);
  }
}

export async function uploadVttFiles(formData) {
  try {
    const response = await apiClient.post(CourseApi.AddingSourse, formData, {
      headers: {
    ...
    throw new Error(`Upload VTT files failed: ${error.message}`);
  }
}
