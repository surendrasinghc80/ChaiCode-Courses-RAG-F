    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url(/gradiant-bg-1.jpg)",
                }}
            />
                    ...
                    <div className="container mx-auto text-center max-w-4xl">
                        ...
                        >
                            ...
                            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                                Transform any document into an intelligent knowledge base. Chat with your content, generate summaries,
                                and create study materials with our advanced RAG technology.
                            </p>
                                ...
                                <CardContent className="p-8">
                                    <div className="grid md:grid-cols-3 gap-6 text-left">
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-sm text-muted-foreground">Drag and drop PDFs, text files, or paste URLs</p>
                                        </div>
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-sm text-muted-foreground">Chat naturally with your documents using AI</p>
                                        </div>
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-sm text-muted-foreground">Create summaries, guides, and audio overviews</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                    ...
                    <div className="container mx-auto max-w-6xl">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                Everything you need to transform documents into actionable insights
                            </p>
                        </div>
                ...
                <section className="py-20 px-4 bg-gradient-to-r from-primary/10 to-accent/10">
                    <div className="container mx-auto text-center max-w-4xl">
                        ...
                        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                            Join thousands of users who are already unlocking insights from their documents with AI-powered analysis.
                        </p>
                    ...
                    <div className="container mx-auto px-4 py-12">
                        <div className="grid md:grid-cols-4 gap-8">
                            <div>
                                ...
                                <p className="text-muted-foreground">AI-powered document analysis and content generation platform.</p>
                            </div>
                        ...
                        <div className="border-t border-border/50 mt-8 pt-8 text-center text-muted-foreground">
                            <p>&copy; 2024 ChaiCode RAG. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
            </div>
